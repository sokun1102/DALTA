...
export default function EditProfileAndAddressesScreen({ navigation, route }) {
  ...
  const handleSaveAddress = async () => {
    ...
    try {
      ...
      if (editingAddress) {
        // Update
        await API.put(`/auth/users/me/addresses/${editingAddress._id}`, addressFormData);
        Alert.alert("Thành công", "Đã cập nhật địa chỉ");
      } else {
        // Add
        await API.post("/auth/users/me/addresses", addressFormData);
      ...
      {!item.is_default && (
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            setAddressFormData({ ...item, is_default: true });
            handleSaveAddress();
          }}
          activeOpacity={0.7}
        >
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.title}>
            {activeTab === "profile" ? "Thông tin cá nhân" : "Địa chỉ giao hàng"}
          </Text>
        </View>
        {activeTab === "addresses" ? (
          <TouchableOpacity 
      ...
      <View style={styles.tabsContainer}>
        ...
        >
          ...
          {activeTab === "addresses" && <View style={styles.activeTabIndicator} />}
        </TouchableOpacity>
      </View>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setAddressFormData({ ...addressFormData, name: text })
                  }
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setAddressFormData({ ...addressFormData, phone: text })
                  }
                  keyboardType="phone-pad"
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setAddressFormData({ ...addressFormData, street: text })
                  }
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setAddressFormData({ ...addressFormData, ward: text })
                  }
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setAddressFormData({ ...addressFormData, district: text })
                  }
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setAddressFormData({ ...addressFormData, zip: text })
                  }
              ...
              >
                <Text style={styles.checkboxText}>
                  {addressFormData.is_default ? "☑" : "☐"} Đặt làm địa chỉ mặc định
                </Text>
              </TouchableOpacity>
            </ScrollView>
            ...
            <View style={styles.modalFooter}>
              <TouchableOpacity
                style={[
                  styles.saveButton,
                  addressSaving && styles.saveButtonDisabled,
                ]}
